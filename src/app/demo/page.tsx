...
export default function FormRendererExample() {
  ...
  const validateAndLoadJson = () => {
    try {
      ...
      if (
        ...
        setJsonError(
          'Invalid survey format. Must contain rootNode with type and items properties.'
        );
        return;
      }
  ...
  return (
    <div className="container-fluid mx-auto min-h-screen flex flex-col">
          ...
          <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
            ...
            <SheetContent className="w-[600px] sm:w-[800px] overflow-y-auto px-4">
              <SheetHeader>
                ...
                <SheetDescription>
                  Paste your survey JSON configuration below to dynamically load
                  a different survey.
                </SheetDescription>
              </SheetHeader>
              ...
              <div className="space-y-4 mt-6">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Button variant="secondary" onClick={clearJson}>
                    Clear
                  </Button>
                </div>
